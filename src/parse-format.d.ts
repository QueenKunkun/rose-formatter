...
export type StartRuleNames = "Main";
export interface ParseOptions<T extends StartRuleNames = "Main"> {
  /**
...
declare function ParseFunction<Options extends ParseOptions<"Main">>(
  input: string,
  options?: Options,
): any;
